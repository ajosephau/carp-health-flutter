...
class Health {
  ...
  ///
  /// Returns the platform record IDs of the inserted records (backport of
  /// the health/14.0.0 behaviour). On iOS this is a single-element list
  /// with the HKWorkout UUID; on Health Connect the exercise session
  /// record ID comes first, followed by the optional distance and energy
  /// records. The first element is what [finishWorkoutRoute] needs as its
  /// `workoutUuid`. Throws on platform failure.
  ///
  /// Parameters:
